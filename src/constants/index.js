...
export const PROJECTS = [
  ...
  },
  {
    ...
    image: project2,
    description:
      "An application for managing tasks and projects, with features such as task creation and Deletion.",
    technologies: ["Reactjs", "Bootstrap"],
    year:"2023"
  },
  {
    title: "Gamifying Anti-Drug Education",
    image: project3,
    description:
      "A gaming experience that educates children, teenagers, and even adults about substance abuse and delinquency.",
  ...
  },
  {
    ...
    image: project4,
    description:
      "Developed a visually appealing and user-friendly interface resembling the original design of Amazon home page.",
...
export const CONTACT = {
  ...
  phoneNo: "+91 620 697 XXXX ",
  email: "rashmiverma19803@gmail.com",
};
